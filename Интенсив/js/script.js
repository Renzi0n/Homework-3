  ...
  function bindSlideToggle(trigger, boxBody, content, openClass) {
      ...
      button.element.addEventListener('click', () => {
        if (button.active === false) {  // Проверяем меню на неактивность
          ...
          box.style.height = 30 + 'px';//раскрыли меню
...
function start () {
  gapi.client.init({
    'apiKey': 'AIzaSyCNsnft3pzrM-sxexnGoIsX-JSpZVHC80M', 
...
function search (target){
  gapi.client.init({
    'apiKey': 'AIzaSyBYWyLfEcFP-AoORZPNcZbvWBNKiaUmpBs', 
    'discoveryDocs': ["https://www.googleapis.com/discovery/v1/apis/youtube/v3/rest"]
  }).then(function(){
...
// AIzaSyBYWyLfEcFP-AoORZPNcZbvWBNKiaUmpBs